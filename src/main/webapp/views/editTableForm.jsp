...
<div class="container-fluid">
	<c:set var="alphabet" value='<%=new String[]{"MONDAY","TUESDAY","WEDNESDAY","THURSDAY","FRIDAY","SATURDAY"} %>'/>
		...
		<form:form method="post" action="/editTable" modelAttribute="TimeTableEntries" onsubmit="return validateForm()">
		<div class="form-group">
			<input type="text" class="form-control" id="classname" name="className" value="${classname }" placeholder="Enter The Class Name" readonly/>
		</div>
			...
			<br>
			<input type="submit" data-toggle="tooltip" title="Edit The Table" name="command" class="btn btn-outline-dark" style="width:100%;" value="EDIT TABLE" height=100% onclick="alert('Please do not refresh the page');"/>
		</form:form>
		</table>
		</div>
		<div>
