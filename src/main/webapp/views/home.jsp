...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-12 col-md-4 classbutton" style="margin-top:1%">
				...
				<% } %>
				<% if(session.getAttribute("isAdmin")!=null){ %>
					<a href="/admin"><button class="btn btn-outline-dark" style="width:100%">Manage Users</button></a>
				<% } %>
			</div>
			<div class="col-12 col-md classClasses">
				<table id="tableID" class="table-dark table-striped col-12" style="margin:1em;width: 95%;">
				<thead >
					<tr style="text-align: center;">
						<th style="width:50% ">Class Names</th>
						<% if(session.getAttribute("uname")!=null){%>
				...
				<c:forEach items="${classNames }" var="classname">
					<tr>
						<td style="width:50%;text-align-last: center" class="classRow"><a href="/viewClass?classname=${classname }" class="adeco">${classname }</a></td>
						<% if(session.getAttribute("uname")!=null){%>
						<th style="width:50%;text-align: center;background-color: white;"><a href="/editClass?classname=${classname }"><button class="btn btn-outline-dark">EDIT</button></a> <a href="/deleteClass?classname=${classname }"><button class="btn btn-outline-dark">DELETE</button></a></th>
						<%} %>
					</tr>
				</c:forEach>
			</table>
